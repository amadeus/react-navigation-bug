    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.inner}>
        <Text style={styles.textIntro}>
          Red represents the safe area padding as provided by React Native Safe Area Context (although I've noticed that
          the issue also affects the build in react native SafeArea component).
        </Text>
        <Text style={styles.textIntro}>
          This only applies to iOS. Ensure you have rotation lock off, and rotate the view into landscape orientation.
          Note how the red safe areas appear. Then tap `Spawn Transparent Modal`, dismiss the modal, and then rotate the
          screen again to see how the safe areas are now stuck as the portrait values. You must force quite the app to
          undo the bug.
        </Text>
        <Pressable style={styles.pressable} onPress={() => navigation.navigate('Modal')}>
          <Text style={styles.text}>"modal"</Text>
        </Pressable>
        <Pressable style={styles.pressable} onPress={() => navigation.navigate('ContainedTransparentModal')}>
          <Text style={styles.text}>"containedTransparentModal"</Text>
        </Pressable>
        <Pressable style={styles.pressable} onPress={() => navigation.navigate('TransparentModal')}>
    ...
    <SafeAreaProvider>
      <NavigationContainer>
        <RootStack.Navigator initialRouteName="Home" screenOptions={{headerShown: false}}>
          ...
          />
          <RootStack.Screen name="Modal" component={Modal} options={{presentation: 'modal'}} />
        </RootStack.Navigator>
      </NavigationContainer>
    </SafeAreaProvider>
  );
